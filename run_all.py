    ...
    for modelindex in range(7):
        ...
        for epoch in range(Epoch):
            ...
            for batchid, data in enumerate(train_loader):
                ...
                if (batchid + 1) % 10 == 0:
                    print(
                        "epoch: {}, batch_id: {}, loss is: {}, acc is: {}".format(epoch, batchid,
                                                                                  loss.detach().cpu().numpy(), acc))
        ...
        for batchid, data in enumerate(test_loader):
            ...
            if (batchid + 1) % 1 == 0:
                print(
                    "测试: {}, batch_id: {}, loss is: {}, acc is: {}".format(0, batchid, loss.detach().cpu().numpy(),
                                                                             acc))
        accs[modelindex] = acc[0]
